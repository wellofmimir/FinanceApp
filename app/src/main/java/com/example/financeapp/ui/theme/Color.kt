...
val Pistachio = Color(0xFFA9E2C7)
val Emerald = Color(0xFF053F1F)

val CharcoalGreen = Color(0xFF282C24)
val SoftMoss     = Color(0xFF9BAF8C)
val SoftJade = Color(0xFF4E7F6A)
val WarmGraphite = Color(0xFF6E6B63)
val SlateBlueGray = Color(0xFF5C6470)
